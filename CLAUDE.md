...
This project is indexed by GitNexus as **CLI-Manager** (3344 symbols, 5824 relationships, 243 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
