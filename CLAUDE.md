...
This project is indexed by GitNexus as **CLI-Manager** (8267 symbols, 15406 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
