...
This project is indexed by GitNexus as **CLI-Manager** (8158 symbols, 15179 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
